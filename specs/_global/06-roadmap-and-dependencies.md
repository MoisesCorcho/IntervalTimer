...
|---|---|---|---|---|
| F01 | [Interval Timer Core](../features/01-interval-timer-core/requirements.md) | Fase 0 · Fundacion | Completado | - |
...
| F13 | [Logros y Badges](../features/13-achievements-badges/requirements.md) | Fase 3 · Seguimiento y Motivacion | Completada (codigo + tests) | F12 (+ F04 SessionLog) |
...
| F30 | [Onboarding](../features/30-onboarding/requirements.md) | Fase 7 · Calidad y Pulido | No iniciada (specs SDD corregidas) | F01 |
