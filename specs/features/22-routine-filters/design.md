...
- Extiende `PresetRoutine` (F03) con metadata: `level`, `equipment: List<String>`, `estimatedDurationSeconds` (derivado, no manual).
- Filtrado 100% en memoria sobre la lista ya cargada de assets locales (no requiere indice/busqueda compleja dado el volumen esperado de contenido).
- UI de filtros tipo bottom sheet con chips seleccionables.
