...
- Paquete `wakelock_plus`, activado al entrar a la pantalla de ejecucion con estado running y desactivado al salir/pausar/terminar.
- Logica encapsulada en la pantalla de ejecucion (`WorkoutSessionScreen`), atada al ciclo de vida del widget, no del `TimerController`, para evitar fugas si el usuario navega fuera.
