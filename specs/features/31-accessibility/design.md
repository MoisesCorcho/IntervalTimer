...
- Auditoria con herramientas de accesibilidad de Flutter (`flutter run --enable-accessibility-checks` / Accessibility Scanner en Android).
- Checklist de accesibilidad incorporado a conventions.md como criterio de 'Definition of Done' para nuevas features a partir de esta.
- Uso sistematico de widgets `Semantics` explicitos en componentes custom (el timer circular, los indicadores de color, etc. no son accesibles por defecto).
