...
- Flag local `hasSeenOnboarding: bool` verificado en el arranque de la app antes de decidir la pantalla inicial.
- Implementado con `PageView` simple + indicadores de pagina, sin dependencias pesadas.
- Contenido de las pantallas de onboarding definido en design-system.md junto con tono de copy de la marca.
