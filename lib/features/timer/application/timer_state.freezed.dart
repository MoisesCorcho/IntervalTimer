...
mixin _$TimerState {
 ...
 TimerStatus get status; Routine? get routine; int get currentIndex; int get remainingMs; int get currentIntervalDurationMs; bool get isPausePending; DateTime? get segmentStartTimestamp; int get pausedAccumulatedMs; DateTime? get sessionStartTimestamp; int get tick;
...
@override
int get hashCode => Object.hash(runtimeType,status,routine,currentIndex,remainingMs,currentIntervalDurationMs,isPausePending,segmentStartTimestamp,pausedAccumulatedMs,sessionStartTimestamp,tick);

@override
String toString() {
  return 'TimerState(status: $status, routine: $routine, currentIndex: $currentIndex, remainingMs: $remainingMs, currentIntervalDurationMs: $currentIntervalDurationMs, isPausePending: $isPausePending, segmentStartTimestamp: $segmentStartTimestamp, pausedAccumulatedMs: $pausedAccumulatedMs, sessionStartTimestamp: $sessionStartTimestamp, tick: $tick)';
}
...
@useResult
$Res call({
 TimerStatus status, Routine? routine, int currentIndex, int remainingMs, int currentIntervalDurationMs, bool isPausePending, DateTime? segmentStartTimestamp, int pausedAccumulatedMs, DateTime? sessionStartTimestamp, int tick
});
...
/// Create a copy of TimerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? routine = freezed,Object? currentIndex = null,Object? remainingMs = null,Object? currentIntervalDurationMs = null,Object? isPausePending = null,Object? segmentStartTimestamp = freezed,Object? pausedAccumulatedMs = null,Object? sessionStartTimestamp = freezed,Object? tick = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TimerStatus status,  Routine? routine,  int currentIndex,  int remainingMs,  int currentIntervalDurationMs,  bool isPausePending,  DateTime? segmentStartTimestamp,  int pausedAccumulatedMs,  DateTime? sessionStartTimestamp,  int tick)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimerState() when $default != null:
return $default(_that.status,_that.routine,_that.currentIndex,_that.remainingMs,_that.currentIntervalDurationMs,_that.isPausePending,_that.segmentStartTimestamp,_that.pausedAccumulatedMs,_that.sessionStartTimestamp,_that.tick);case _:
  return orElse();
...
class _TimerState extends TimerState {
  const _TimerState({this.status = TimerStatus.idle, this.routine, this.currentIndex = 0, this.remainingMs = 0, this.currentIntervalDurationMs = 0, this.isPausePending = false, this.segmentStartTimestamp, this.pausedAccumulatedMs = 0, this.sessionStartTimestamp, this.tick = 0}): super._();
...
/// Create a copy of TimerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? routine = freezed,Object? currentIndex = null,Object? remainingMs = null,Object? currentIntervalDurationMs = null,Object? isPausePending = null,Object? segmentStartTimestamp = freezed,Object? pausedAccumulatedMs = null,Object? sessionStartTimestamp = freezed,Object? tick = null,}) {
